...
const SplitForm = ({ onClose }: SplitFormProps) => {
  ...
  return (
    <motion.form
      ...
      onClick={(e) => e.stopPropagation()} // prevent overlay clicks from closing
      className="bg-white rounded-3xl shadow-2xl p-8 space-y-6 max-w-lg w-full relative border border-rose-200"
