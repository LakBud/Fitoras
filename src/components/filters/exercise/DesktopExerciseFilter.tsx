          ...
          <div key={key} className="relative flex-shrink-0 w-40 md:w-40">
            ...
            <Select value={filters[key] || "__all__"} onValueChange={(v) => changeFilter(key, v)}>
              ...
              <SelectContent className="rounded-xl border-red-200 shadow-xl">
                ...
                {values.map((value) => (
                  <SelectItem key={value} value={value} className="font-medium focus:bg-red-50 focus:text-red-700">
...
export default DesktopExerciseFilter;
